...
const ORDEREDLIST = ({ isEnglish, children }) => {
    return (
        <ol className="text-base lg:text-lg listDecimal" style={{ listStyle: "decimal !important", direction: isEnglish ? 'unset' : 'rtl', marginRight: isEnglish ? 'unset' : '1.5rem' }}>{children}</ol>
    );
};
