...
const ORDEREDLIST = ({ isEnglish, children }) => {
    return (
        <ol className="text-base lg:text-lg list-decimal" style={{ listStyle: "decimal !important", direction: isEnglish ? 'unset' : 'rtl', marginRight: isEnglish ? 'unset' : '1.5rem' }}>{children}</ol>
    );
};
